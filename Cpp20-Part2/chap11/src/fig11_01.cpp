...
int main() {
    std::string s1{"happy"}; // initialize string froem char*
    ...
    // test string member functions empty
    ...
    // test string concatenation with a C++ string-object literal
    ...
    std::cout << "initializing s5 with string view v\n";
    std::string s5{v};
